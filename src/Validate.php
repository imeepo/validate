...
use imeepo\validate\validate\ValidateRule;

/**
 * 数据验证类
 * @package imeepo\validate
 */
class Validate
{
    /**
    ...
    public function check(array $data, array $rules = []): bool
    {
        ...
        foreach ($rules as $key => $rule) {
            ...
            // 场景检测
            if (!empty($this->only) && !array_key_exists($key, $this->only)) {
                continue;
            }
